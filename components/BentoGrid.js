        ...
        <section id="about" className="p-4 sm:p-8 md:p-16 mx-4 sm:mx-8 md:mx-16 text-foreground">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="bg-secondary p-4 sm:p-5 rounded-2xl border-accent transition duration-300 ease-in-out hover:border-2 hover:scale-95 shadow shadow-black">
                    ...
                    <p className="text-primary text-sm sm:text-base"><span className='text-smu'>SMU</span> HackBIA is an exciting datathon hosted by <span className='text-smu'>SMU</span>'s Business Intelligence & Analytics. It's a platform for students to collaborate, innovate, and create impactful solutions to real-world problems using technology.</p>
                </div>
                <div className="bg-secondary shadow-inner p-4 sm:p-5 rounded-2xl sm:col-span-1 border-accent transition duration-300 ease-in-out hover:border-2 hover:scale-95 shadow shadow-black">
                    ...
                    <p className="text-primary text-sm sm:text-base"><span className='text-smu'>SMU</span> HackBIA is open to all university students, regardless of their major or coding experience. Whether you're a seasoned programmer or a curious beginner, you're welcome to join and learn!</p>
                </div>
                ...
                <div className="bg-secondary shadow-inner p-4 sm:p-5 rounded-2xl col-span-1 sm:col-span-1 lg:col-span-2 border-accent transition duration-300 ease-in-out hover:border-2 hover:scale-95 shadow shadow-black">
                    ...
                    <p className="text-primary text-sm sm:text-base mb-2"><span className='text-smu'>SMU</span> HackBIA kicks off on August 15th at 6 PM and concludes on August 16th at 6 PM. This year's theme is "Tech for Social Good," challenging participants to develop solutions that address pressing social issues.</p>
                ...
                <div className="bg-secondary shadow-inner p-4 sm:p-5 rounded-2xl col-span-1 sm:col-span-1 lg:col-span-1 border-accent transition duration-300 ease-in-out hover:border-2 hover:scale-95 shadow shadow-black">
                    ...
                    <p className="text-primary text-sm sm:text-base">Prepare a compelling presentation and demo to showcase your project's features and functionalities. Good luck!</p>
                </div>
            </div>
        </section>
    );
