...
const CountdownTimer = () => {
    ...
    const TimerBlock = ({ value, label }) => (
        <div className="flex flex-col items-center">
            <span className="text-foreground font-bold sm:text-2xl text-xl tracking-normal">{label}</span>
            <div className="relative mt-2 md:w-[160px] md:h-[160px] sm:w-[120px] sm:h-[120px] w-[80px] h-[80px]">
    ...
    return (
        <section className="container mx-auto max-w-screen-xl px-4">
            <h1 id="how-we-roll" className="text-6xl font-semibold tracking-tighter text-center text-foreground">
                Time until the <span className="text-accent">hackython</span>.
            </h1>
            <div className="rounded-[20px] flex flex-col items-center py-8 px-3 shadow-card mt-5 bg-card">
                <div className="flex text-foreground md:text-8xl sm:text-6xl text-4xl font-bold tracking-tighter p-3 gap-3">
